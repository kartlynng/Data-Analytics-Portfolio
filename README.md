...
| Project <img width="220" height="1"> | Stack <img width="140" height="1"> | Scope <img width="180" height="1"> | Headline Finding |
| :--- | :--- | :--- | :--- |
| [**🛒 E-Commerce Customer Analytics**](https://github.com/kartlynng/Data-Analytics-Portfolio/tree/main/online-retail-analytics)<br><sub>[Live Dashboard ↗](https://public.tableau.com/app/profile/trinh.nguyen3873/viz/UCIOnlineRetail_17853364241720/Dashboard1?publish=yes)</sub> | BigQuery SQL<br>Tableau | • 541,909 transactions<br>• 4,372 customers<br>• 38 countries<br>• Dec 2010 – Dec 2011 | • RFM segmentation isolated **667 lapsed high-value accounts** — 15.4% of the customer base, averaging $1,290.8 lifetime value and \~152 days inactive.<br>• A **~$861K book of recoverable revenue** that no existing campaign was targeting. |
| [**🎬 Netflix Content Strategy**](https://github.com/kartlynng/Data-Analytics-Portfolio/tree/main/netflix-content-strategy) | BigQuery SQL | • 8,807 titles<br>• 12 attributes<br>• Catalog through 2021 | • Production hubs specialise sharply by genre — the **US in Dramas, India in International Movies, the UK in British TV**.<br>• Drama is the only genre ranking top-3 in all three markets, making it the single defensible target for cross-market investment. |
| [**🎵 Spotify Retention Pipeline**](https://github.com/kartlynng/Data-Analytics-Portfolio/tree/main/spotify-user-churn)<br><sub>🚧 In progress — target August 2026</sub> | Google Sheets API<br>PostgreSQL<br>Python<br>Power BI | • 50,000 subscriber profiles | • Four-layer pipeline with a raw/staging/mart warehouse, automated data-quality gates, and a governed Sheets reference layer.<br>• Design document published; implementation underway. |
...
| :--- | :--- | :--- | :---: |
| **Google Data Analytics Professional Certificate** | Coursera / Google | 🟢 Completed | [Verify Certificate](https://www.coursera.org/account/accomplishments/specialization/RTH3F1V5EH8R)|
| **Google AI Essentials** | Coursera / Google | 🟢 Completed | [Verify Certificate](https://www.coursera.org/account/accomplishments/specialization/1CPRRWOZEO8W) |
...
* 💼 **LinkedIn:** [Kartlyn Nguyen](https://www.linkedin.com/in/kartlyn-nguyen/)
* 📧 **Primary Email:** [kartlyn.nguyen@gmail.com](mailto:kartlyn.nguyen@gmail.com)
* 🐻 **Cal Mail (until I walk the stage! 🎓):** [kartlyn_ng@berkeley.edu](mailto:kartlyn_ng@berkeley.edu)
